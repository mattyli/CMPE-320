...
#include "fraction_19ml105.h"	// Add your netid to the #include
...
int main() {
	...
	Fraction test6(9, 8);
	Fraction test7(1, 6);
	Fraction test8 = test6 + test7;		// test6 is calling the '+' operator
	...
	Fraction test14 = 5 * test12;
	cout << "should be 15/16: " << test14 << endl; 
	...
	Fraction test30 = 2 + test3++;
	cout << "Should be \"8/3\": " << test30 << endl;
	...
	do {
		...
		try {
			...
			//cout << "fin.numerator = " << fin.numerator() << " fin.denominator = " << fin.denominator() << endl;
